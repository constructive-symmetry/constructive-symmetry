...
The **theory track** is more like a series of travel brochures: these projects are trying to convince you to go learn something for yourself.  In stark contrast to the praxis tracks, nobody is expected to really understand anything of direct practicality from watching or reading these projects for the first time. Instead they are intended to provide suggestions, ideas, hints, and clues about what to study next.
