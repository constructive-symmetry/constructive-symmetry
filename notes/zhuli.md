...
"requires" vectors and/or linear algebra in order to accept the use of `1/0`.
...
argument is also assuming the consequent. This is of course not true, but it
does depend on a (co-)inductive proof, the details of which aren't delved into.
...
the Rationals", (2) a more classical proof employing proof by contradiction
that appears in Concrete Mathematics.
...
(Incidentally, I also think this may have something to do with my preferred
notions of existence. [Martin Escardo explains:](https://mathstodon.xyz/@MartinEscardo/115063264039556362)
